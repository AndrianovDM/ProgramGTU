...
def lossesCAC(velocity_inlet, velocity_outlet, height, pitch, width, chord, te_radius, a_outlet, 
              blade_inlet_angle, inlet_angle, outlet_angle, design_inc, nu, ks, method_2):
    ...
    Re = velocity_outlet * a_outlet / nu
